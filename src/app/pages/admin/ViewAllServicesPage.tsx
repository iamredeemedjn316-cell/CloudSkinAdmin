...
const allServices = [
  { id: "SRV001", name: "Hydra Facial", category: "Facial", price: "₱2,500", duration: "60 min", status: "active", archived: false },
  { id: "SRV002", name: "Botox Treatment", category: "Injectables", price: "₱8,000", duration: "45 min", status: "active", archived: false },
  { id: "SRV003", name: "Chemical Peel", category: "Facial", price: "₱3,500", duration: "45 min", status: "inactive", archived: false },
  { id: "SRV004", name: "PRP Therapy", category: "Hair Treatment", price: "₱12,000", duration: "90 min", status: "active", archived: false },
            ...
            {displayed.map((service) => (
              <tr key={service.id} style={{ borderBottom: "1px solid #D0E8F5", cursor: "pointer" }} onMouseEnter={(e) => (e.currentTarget.style.background = "#F8FBFF")} onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}>
                ...
                <td style={{ padding: "16px 24px", textAlign: "center", display: "flex", gap: "8px", justifyContent: "center" }}>
                  ...
                  {!service.archived && (
                    <button onClick={() => handleArchiveService(service.id)} style={{ width: "32px", height: "32px", background: "#FEE2E2", border: "none", borderRadius: "6px", cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", color: "#DC2626" }} title="Archive service">
                      <Archive size={14} />
                    </button>
                  )}
                </td>
